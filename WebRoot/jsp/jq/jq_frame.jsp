...
<iframe src="jsp/jq/jq_frame2.jsp" id="frame1" name="frame1" style="border: 1px solid #cccccc"></iframe>
<iframe src="jsp/jq/jq_frame3.jsp" id="frame2" name="frame2" style="border: 1px solid #cccccc"></iframe><br/>
